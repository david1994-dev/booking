  ...
  <div>
    ...
    <div id="main-content">
      <div class="left-content">
        ...
        <CategoryList :text="'Xu hướng tóc'" :routeName="'ChildCategory'"
                      :routeParams="{
                        category: 'hair',
                        slug: 1
                      }"
        ...
        <CategoryList :text="'Xu hướng nail'" :routeName="'ChildCategory'"
                      :routeParams="{
                        category: 'nail',
                        slug: 1
                      }"
        ...
        <CategoryList :text="'Xu hướng beauty'" :routeName="'ChildCategory'"
                      :routeParams="{
                        category: 'beauty',
                        slug: 1
                      }"
